...
class ExacerbationController extends CustomRestController
{
    public $modelClass = 'app\models\Exacerbation';
    ...
    {
        return Exacerbation::findAll(['user_id' => \Yii::$app->user->identity->id]);
    }
